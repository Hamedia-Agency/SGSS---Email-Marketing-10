        ...
        <div className={styles.eyjiCtaPanel}>
          ...
          <div className={styles.eyjiCtaCopy}>
            ...
            <h2 className={styles.eyjiCtaTitle}>
              Get Supervised Protection Today
            </h2>

            <p className={styles.eyjiCtaText}>
              Secure Guard can review your current security structure and help you identify whether stronger field oversight, clearer performance standards, or better reporting would improve your coverage.
              <br /><br />
              Complete the short form and tell us about your property, current security service, and any concerns you have experienced.
            </p>
